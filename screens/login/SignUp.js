...
const SignUp = ({ navigation }) => {
    ...
    const formValidation = () => {
        if (fullname == '' || email == '' || password == '' || cpassword == '' || phonenumber == '' || voterId == '') return false
        else return true
    }
    ...
    const signup_details = async () => {
        ...
        console.log("Check validation", formValidation(), checkNumber(),checkEmail(),checkConfirmPassword())
        ...
        if (formValidation()) {
            if(checkNumber()){
                    ...
                    if (checkConfirmPassword()) {
                        try {
                            ...
                            if (data.status === 200) {
                                ...
                                navigation.navigate('OtpScreen',{signup:article})
                ...
                // Alert.alert("Please provide valid email.")
                setModalVisible(true)
                setDynamicModalText("Please provide a valid number.")
            }         
                   ...
                   <View style={{ marginBottom: 25 }}>
                    ...
                    <View style={{ marginBottom: 25 }}>
                        ...
                        <TextInput
                            style={styles.inputBox}
                            keyboardType='email-address'
                            placeholder={strings.voterId}
                            autoCapitalize="none"
                            onChangeText={(value) => setvoterId(value)}
                        />
