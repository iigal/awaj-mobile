        ...
        if (formValidation()) {
            ...
            if (checkEmail()) {
                try {
                    ...
                    console.log("Login data",data.data.status)
                    if (data.data.status === 201) {
                        ...
                        // Alert.alert("No User found")
                        setModalVisible(true)
                        setDynamicModalText("You can login after your account has been approved.")
                        ...
                        // Alert.alert("No User found")
                        setModalVisible(true)
                        setDynamicModalText("Your account has been rejected. Please signup again with correct details.")
